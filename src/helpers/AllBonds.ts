...
import { abi as UsdbABondDepositoryContract } from "../abi/bonds/UsdbABondDepository.json";
import { abi as UsdbBBondDepositoryContract } from "../abi/bonds/UsdbBBondDepository.json";
import { abi as UsdbA2BondDepositoryContract } from "../abi/bonds/UsdbA2BondDepository.json";
import { abi as UsdbFhmBurnBondDepositoryContract } from "../abi/bonds/UsdbFhmBurnBondDepository.json";
...
export const wftm_44 = new CustomBond({
  ...
  customTreasuryBalanceFunc: async function (this: CustomBond, networkId: any) {
